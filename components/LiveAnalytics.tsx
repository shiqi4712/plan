...
export default function LiveAnalytics({ initial, history }: { initial: LiveAnalyticsData; history: HistoryData | null }) {
  ...
  const name = courses.find(c => c.id === filter.course)?.name || '全部 8 条链接';
  function exportData() {
